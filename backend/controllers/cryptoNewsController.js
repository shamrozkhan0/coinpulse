import { askGPT } from "./geminiAIController.js";

export const getCryptoNewsByCoin = async (req, res) => {
    const coinName = req.params.coin;
    try {
        // const coinNews = await fetch(
        //     `https://newsapi.org/v2/everything?q=${coinName}&sortBy=publishedAt&language=en&pageSize=3&apiKey=${process.env.CRYPTO_NEWS_API_KEY}`
        // );
